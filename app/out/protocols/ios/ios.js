...
class IOSProtocol extends protocol_1.ProtocolAdapter {
    ...
    onPushNodesByBackendIdsToFrontend(msg) {
        ...
        for (let i = 0; i < msg.params.backendNodeIds.length; i++) {
            ...
            const pushNode = this._target.callTarget('DOM.pushNodeByBackendIdToFrontend', params).then((result) => result.nodeId);
    ...
    onStartScreencast(msg) {
        ...
        this._screencastSession = new screencast_1.ScreencastSession(this._target, msg.params.format, msg.params.quality, msg.params.maxWidth, msg.params.maxHeight);
